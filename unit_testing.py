...
def main():
    ...
    original_path = 'C:/Users/AISHWARYA KASHYAP/PycharmProjects/MajorProject/Au1/*.jpg'
    ...
    test_images(original_paths, "original")
        ...
        # Test forged images
    #forged_path = 'C:/Users/purpu/OneDrive/Pictures/forged/*.jpg'
    forged_path = 'C:/Users/AISHWARYA KASHYAP/PycharmProjects/MajorProject/Modified/CM1/*.jpg'
    ...
    with open(filename, "w+") as file:
        ...
        file.write("Forged images: " + str(len(forged_paths)) + "\n")
